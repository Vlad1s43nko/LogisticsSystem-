{filtersActive.dateRange && dateRange.end && (
    <React.Fragment>
        <div className="filter-active-indicator" title={`End date: ${dateRange.end}`}></div>
    </React.Fragment>
)}// Dashboard Component
const Dashboard = () => {
...
/>
{filtersActive.dateRange && dateRange.start && (
    <React.Fragment>
        <div className="filter-active-indicator" title={`Start date: ${dateRange.start}`}></div>
    </React.Fragment>
)}
</div>
<div className="filter-container">
